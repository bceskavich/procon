...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    var ReactHotAPI = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"),
	        RootInstanceProvider = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/RootInstanceProvider.js"),
	  ...
	  var ProConApp = __webpack_require__(1);
	  var FirebaseUtil = __webpack_require__(21);
	  var React = __webpack_require__(23);

	  FirebaseUtil.loadPage();

	  React.render(React.createElement(ProConApp, null), document.getElementById("proconapp"));
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  var _ProConSection = __webpack_require__(2);

	  var _ProConSection2 = _interopRequireDefault(_ProConSection);

	  var _storesAppStore = __webpack_require__(20);

	  var _storesAppStore2 = _interopRequireDefault(_storesAppStore);

	  var _actionsActions = __webpack_require__(4);
	  ...
	  function getStateFromStore() {
	    return {
	      ref: _storesAppStore2["default"].getState().firebaseRef,
	      pros: _storesAppStore2["default"].getState().pros,
	      cons: _storesAppStore2["default"].getState().cons
	    };
	  }

	  var ProConApp = (function (_React$Component) {
	    function ProConApp(props, context) {
	      _classCallCheck(this, ProConApp);

	      _get(Object.getPrototypeOf(ProConApp.prototype), "constructor", this).call(this, props, context);
	    ...
	    _inherits(ProConApp, _React$Component);

	    _createClass(ProConApp, [{
	      key: "componentDidMount",
	      value: function componentDidMount() {
	        _storesAppStore2["default"].listen(this._onChange);
	      }
	    }, {
	      ...
	      value: function render() {
	        ...
	        if (this.state.ref) {
	          ...
	          buttonOrLink = _react2["default"].createElement("a", { href: linkPath }, linkPath);
	        } else if (this.state.pros.length > 0 || this.state.cons.length > 0) {
	          buttonOrLink = _react2["default"].createElement("button", { className: "active", onClick: this._saveSession }, "Save Your List");
	        } else {
	          buttonOrLink = _react2["default"].createElement("button", { disabled: true, onClick: this._saveSession }, "Save Your List");
	        }

	        return _react2["default"].createElement("div", null, _react2["default"].createElement("div", null, _react2["default"].createElement("section", { className: "pros" }, _react2["default"].createElement("h1", null, "Pros"), _react2["default"].createElement(_ProConSection2["default"], { type: "pros", items: _storesAppStore2["default"].getAllChrono("pros") })), _react2["default"].createElement("span", null), _react2["default"].createElement("section", { className: "cons" }, _react2["default"].createElement("h1", null, "Cons"), _react2["default"].createElement(_ProConSection2["default"], { type: "cons", items: _storesAppStore2["default"].getAllChrono("cons") }))), _react2["default"].createElement("div", { className: "save" }, buttonOrLink));
	      }
	    }, {
	      key: "_onChange",
	      ...
	      value: function _saveSession() {
	        _actionsActions2["default"].createNewStore();
	      }
	    }]);
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "ProConApp.js" + ": " + err.message);
	          }
	        });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  var _ProConItem = __webpack_require__(3);

	  var _ProConItem2 = _interopRequireDefault(_ProConItem);

	  var _Composer = __webpack_require__(179);
	  ...
	  function getItemList(items) {
	    ...
	    var itemList = items.map(function (item) {
	      return _react2["default"].createElement(_ProConItem2["default"], { key: item.id, item: item });
	    });
	    return _react2["default"].createElement("ul", null, itemList);
	  }

	  function getClearButton(handler) {
	    return _react2["default"].createElement("a", { onClick: handler }, "Clear All");
	  }

	  var ProConSection = (function (_Component) {
	    function ProConSection(props, context) {
	      _classCallCheck(this, ProConSection);

	      _get(Object.getPrototypeOf(ProConSection.prototype), "constructor", this).call(this, props, context);
	      this._clearAll = this._clearAll.bind(this);
	    }

	    _inherits(ProConSection, _Component);

	    _createClass(ProConSection, [{
	      key: "render",
	      value: function render() {
	        var clear;
	        ...
	        return _react2["default"].createElement("div", { className: this.props.type + "-section" }, _react2["default"].createElement(_Composer2["default"], { type: this.props.type }), getItemList(this.state.items), _react2["default"].createElement("div", { className: "clear" }, clear));
	      }
	    }, {
	      key: "_clearAll",
	      value: function _clearAll() {
	        _actionsActions2["default"].deleteAll(this.props.type);
	      }
	    }]);

	    return ProConSection;
	  })(_react.Component);
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "ProConSection.js" + ": " + err.message);
	          }
	        });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  var ProConItem = (function (_Component) {
	    function ProConItem(props, context) {
	      _classCallCheck(this, ProConItem);

	      _get(Object.getPrototypeOf(ProConItem.prototype), "constructor", this).call(this, props, context);
	      this._changeWeight = this._changeWeight.bind(this);
	      this._delete = this._delete.bind(this);
	      this._getWeightClass = this._getWeightClass.bind(this);
	    }

	    _inherits(ProConItem, _Component);

	    _createClass(ProConItem, [{
	      key: "render",
	      value: function render() {
	        return _react2["default"].createElement("li", { className: this._getWeightClass() }, _react2["default"].createElement("a", { onClick: this._delete }, _react2["default"].createElement("i", { className: "ion-close" })), _react2["default"].createElement("div", { onClick: this._changeWeight }, this.props.item.text));
	      }
	    }, {
	      key: "_changeWeight",

	      // Handles changing the weight of the item
	      value: function _changeWeight() {
	        _actionsActions2["default"].changeItemWeight(this.props.item.id, this.props.item.type);
	      }
	    }, {
	      key: "_delete",
	      ...
	      value: function _delete() {
	        _actionsActions2["default"].deleteItem(this.props.item.id, this.props.item.type);
	      }
	    }, {
	      key: "_getWeightClass",
	      value: function _getWeightClass() {
	        var weight = this.props.item.weight;
	        if (weight == 1) {
	          return "one";
	        } else if (weight == 2) {
	          return "two";
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "ProConItem.js" + ": " + err.message);
	          }
	        });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  var _alt = __webpack_require__(5);
	  ...
	  var PCActions = function PCActions() {
	    _classCallCheck(this, PCActions);

	    this.generateActions("createItem", "deleteItem", "changeItemWeight", "deleteAll", "createNewStore", "loadPage");
	  };

	  exports["default"] = _alt2["default"].createActions(PCActions);
	  module.exports = exports["default"];
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "alt.js" + ": " + err.message);
	          }
	        });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(10);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _symbolsSymbols = __webpack_require__(11);

	var Sym = _interopRequireWildcard(_symbolsSymbols);

	var _utilsFunctions = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _esSymbol = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventemitter3 = __webpack_require__(15);
	...
	var _StoreMixin = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  var _utilsFirebaseUtil = __webpack_require__(21);
	  ...
	  var AppStore = (function () {
	    function AppStore() {
	      ...
	      this.bindActions(_actionsActions2["default"]);
	    ...
	    _createClass(AppStore, [{
	      ...
	      key: "onChangeWeight",
	      value: function onChangeWeight(item) {
	      ...
	      key: "onDeleteAll",
	      value: function onDeleteAll(type) {
	        this.items[type] = {};
	      }
	    }, {
	      ...
	      key: "getItem",
	      value: function getItem(id, type) {
	        return this.items[type][id];
	      }
	    }, {
	      key: "getFirebaseRef",
	      value: function getFirebaseRef() {
	        if (this.firebaseRef) {
	          return firebaseRef;
	        } else {
	          return null;
	      ...
	      key: "getAllChrono",
	      value: function getAllChrono(type) {
	        var items = [];
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "AppStore.js" + ": " + err.message);
	          }
	        });
	      }
	    }
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "FirebaseUtil.js" + ": " + err.message);
	          }
	        });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var quoteAttributeValueForBrowser = __webpack_require__(67);
	var warning = __webpack_require__(37);
	...
	if (false) {
	  ...
	  var Composer = (function (_Component) {
	    function Composer(props, context) {
	      ...
	      _get(Object.getPrototypeOf(Composer.prototype), "constructor", this).call(this, props, context);
	      this.state = { text: "" };
	      this._onChange = this._onChange.bind(this);
	    ...
	    _createClass(Composer, [{
	      ...
	      value: function _onKeyDown(event) {
	        if (event.keyCode === ENTER_KEY_CODE) {
	          ...
	          if (text) {
	            _actionsActions2["default"].createItem(text, this.props.type);
	          }
	          this.setState({ text: "" });
	        }
	      }
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/Billy/PROJECTS/node/procon/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "Composer.js" + ": " + err.message);
	          }
	        });
	      }
	    }
